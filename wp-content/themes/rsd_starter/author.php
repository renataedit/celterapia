<?php get_header(); ?>
	...
	<div class="container">
		<header class="page-header">
			<h1 class="page-title"><?php echo get_the_author_meta('last_name') . ' ' . get_the_author_meta('first_name'); ?> Cikkjei</h1>
			<div class="page-description"><?php echo get_the_author_meta('description'); ?></div>
		</header>
